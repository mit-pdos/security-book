...
a *model* of the system and the adversary,
a security *goal*,
an *implementation*.
...
*worst-case situations*, while correctness is often
about behavior in
*expected situations* (i.e., *average-case situations*).
...
### Designing security goals and a threat model
