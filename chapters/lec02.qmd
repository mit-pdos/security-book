...
![There are (at least) three interesting security goals for client-server authentication systems: (a) direct attack, (b) eavesdropping attack, and (c) active attack.](/figs/auth-attacks.svg){#fig-auth-attacks width=90%}
...
: The most popular passwords in 2021, according to NordPass, <https://nordpass.com/most-common-passwords-list/>.
:::
